...
<form
  ...
  <button class="rounded-md bg-orange-400 p-2 col-span-2" type="submit">Sign Up</button>
  {#if errorMessage} <div class="text-xs text-red-600 col-span-2">{errorMessage}</div>{/if}
</form>
