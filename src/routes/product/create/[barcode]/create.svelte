...
<form
	...
	<button
		...
		class="i-octicon:upload-16 col-span-1 cursor-pointer place-self-end rounded-full bg-orange-500 p-2 text-xl"
		type="submit">
	</button>
	<br />
	<hr class="col-span-2 border-orange-500" />
