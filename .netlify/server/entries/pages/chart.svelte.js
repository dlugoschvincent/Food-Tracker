...
const Chartjstest = (0, import_index_4c9ca1e2.c)(($$result, $$props, $$bindings, slots) => {
  let ctx;
  return `<div class="${"mx-auto max-w-xl"}"><canvas${(0, import_index_4c9ca1e2.j)("this", ctx, 0)}></canvas></div>`;
});
const Chart = (0, import_index_4c9ca1e2.c)(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Dashboard</title>`, ""}`, ""}
${(0, import_index_4c9ca1e2.v)(Chartjstest, "Chartjstest").$$render($$result, {}, {}, {})}`;
});
